...
public class DocumentImplTest {
    ...
    public void setUp() throws Exception {
        ...
        textDocument = new DocumentImpl(uri, content, null);
    ...
    public void DocumentImplNullConstructorTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            new DocumentImpl(null, content, null);
        });
    }
    ...
    public void DocumentImplEmptyConstructorTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            new DocumentImpl(new URI(""), content, null);
        });
    }
    ...
    public void DocumentImplEmptyContentTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            new DocumentImpl(this.uri, "", null);
        });
    }
    ...
    public void DocumentImplNullContentTest() {
        assertThrows(IllegalArgumentException.class, () -> {
            new DocumentImpl(this.uri, (String) null, null);
        });
    }
